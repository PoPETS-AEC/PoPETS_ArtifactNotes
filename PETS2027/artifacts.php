...
<div class="content">
  ...
  <h2 class="text-headings"><u>PoPETs 2027 Artifact Evaluation</u></h2>
 ...
 <ol>
  ...
  <p>To be relevant to the paper, the released artifact must contain all
    material, code, data, etc., that was used to perform the research and that a
    reader would expect to find in the artifact associated to the paper.</p>
  ...
  <p>To award the “Artifact Reproduced” badge, reviewers must be able to
    ...
    claims made in the paper. In this case, please discuss with the other
    reviewers or include the artifact chairs in the discussion. It is the
    reviewer’s role to enforce that these quantitative and/or qualitative
    expectations are met before awarding the “Artifact Reproduced” badge.</p>
  ...
  <p>When the artifact evaluation is over, a persistent and stable link
    ...
    picked, this is likely a link to a specific Git commit or a DoI for
  ...
  <h2 class="text-headings sub-heading" id="faq">Frequently Asked Questions
    ...
    <h3 id="faq-human-research">What artifact should be released by authors of usable security and privacy papers (i.e., human subject research)?</h3>
  <p>We invite authors of human subject research papers to release for transparency all materials that they prepared for the execution of their study. For example, these would likely include:</p>
  <ul>
    <li>User study questionnaire like surveys or interview guides (exported in a readable and easy to reuse format, e.g., text or markdown over pdf).</li>
    <li>Recruitment materials, consent forms, and other experimental materials.</li>
    <li>If participants were informed of, and consented to,
      <em>anonymized</em> transcript or responses being released, explicitly
      mention this, and release these transcripts, questionnaire
      responses, collected data, and codebooks.
    </li>
    <li>We also recommend including demographics of your user study
      participants.</li>
    <li>Similarly, any code or scripts used for instance to extract statistics or plot figures should also be released.</li>
  </ul>

  <p>To read more about transparency efforts in human subject research see this <a href="https://www.usenix.org/conference/usenixsecurity25/presentation/klemmer">2025 study</a>. An example of a <a
      href="https://github.com/blues-lab/priv-eng-dataset/tree/ca35ffbb3c38ff7877c01ee92bfda29b2033ae6e">good
      user study artifact</a> is available here.</p>
  ...
  <ul>
    ...
    <li>The code of your crawling pipeline. To evaluate the functionality,
      please provide a small crawling experiment on a few pages.
    </li>
  </ul>
